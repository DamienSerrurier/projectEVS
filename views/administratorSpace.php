...
<body>
    ...
    <div class="row">
        <div class="col-xl-3">
            <menu class="d-none d-xl-block">
                <li class="border border-2 py-3 text-center" value="">Gestion des utilisateurs</li>
                <li class="border border-2 py-3 text-center" value="1">Gestion des données personnelles</li>
                <li class="border border-2 py-3 text-center" value="2">Gestion des rôle</li>
                <li class="border border-2 py-3 text-center" value="3">Gestion des catégories activités</li>
                <li class="border border-2 py-3 text-center" value="4">Gestion des activités</li>
                <li class="border border-2 py-3 text-center" value="5">Gestion des type de structure</li>
                <li class="border border-2 py-3 text-center" value="6">Gestion des structures</li>
                <div class="d-flex justify-content-center"><button class="btn btn-secondary text-uppercase">Annulation</button></div>
            </menu>
        </div>
        ...
        <div class="col-xl-9" id="category">
            <form action="administratorSpace?categoryMenu=<?= $categoryMenu ?>" method="post" id="form">
                ...
                <input class="btn btn-warning text-uppercase" type="submit" name="update" value="Modification">
                <input class="btn btn-success text-uppercase" type="submit" name="create" value="Création">
            </form>
        </div>
    </div>
