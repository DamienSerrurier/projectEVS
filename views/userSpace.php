                        ...
                        <div id="memberResponsible">
                            ...
                            ?>
                                    ...
                                    <fieldset class="box rounded p-4 mt-5" form="">
                                        ...
                                        ?>
                                                <input class="form-check-input choice" type="radio" name="memberCivility<?= $i ?>" id="memberCivility <?= htmlspecialchars($value->getId()) . $i ?>" value="<?= $value->getId() ?>" <?= $checked ?>>
                                                <label class="form-label-lg fs-6" for="memberCivility <?= htmlspecialchars($value->getId()) . $i ?>"><?= htmlspecialchars($value->getName()) ?></label>
                                        <?php
                                            endforeach;
                                        endif;
                                        ?>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-10 col-md-4 col-xl-6 mt-3">
                                                ...
                                                ?>
                                                <p class="text-danger m-0 error-message" id="error-memberLastname<?= $i ?>"><?= isset($arrayInfoMessages[$i]['memberLastname' . $i]) && !empty($arrayInfoMessages[$i]['memberLastname' . $i]) ? htmlspecialchars($arrayInfoMessages[$i]['memberLastname' . $i]) : '' ?></p>
                                            </div>
                                            <div class="col-sm-10 col-md-4 col-xl-6 mt-3">
                                                ...
                                                ?>
                                                <p class="text-danger m-0 error-message" id="error-memberFirstname<?= $i ?>"><?= isset($arrayInfoMessages[$i]['memberFirstname' . $i]) && !empty($arrayInfoMessages[$i]['memberFirstname' . $i]) ? htmlspecialchars($arrayInfoMessages[$i]['memberFirstname' . $i]) : '' ?></p>
                                            </div>
                                            <div class="col-sm-10 col-md-4 col-xl-6 mt-3">
                                                ...
                                                ?>
                                                <p class="text-danger m-0 error-message" id="error-memberMail<?= $i ?>"><?= isset($arrayInfoMessages[$i]['memberMail' . $i]) && !empty($arrayInfoMessages[$i]['memberMail' . $i]) ? htmlspecialchars($arrayInfoMessages[$i]['memberMail' . $i]) : '' ?></p>
                                            </div>
                                            <div class="col-sm-10 col-md-4 col-xl-6 mt-3">
                                                ...
                                                <p class="text-danger m-0 error-message" id="error-memberPhone<?= $i ?>"><?= isset($arrayInfoMessages[$i]['memberPhone' . $i]) && !empty($arrayInfoMessages[$i]['memberPhone' . $i]) ? htmlspecialchars($arrayInfoMessages[$i]['memberPhone' . $i]) : '' ?></p>
                                            </div>
                                            <div class="col-sm-10 col-md-4 col-xl-6 mt-3">
                                                ...
                                                <p class="text-danger m-0 error-message" id="error-memberBirthdate<?= $i ?>"><?= isset($arrayInfoMessages[$i]['memberBirthdate' . $i]) && !empty($arrayInfoMessages[$i]['memberBirthdate' . $i]) ? htmlspecialchars($arrayInfoMessages[$i]['memberBirthdate' . $i]) : '' ?></p>
                                            </div>
                                            <div class="col-sm-10 col-md-4 col-xl-6 mt-3">
                                                ...
                                                <p class="text-danger m-0 error-message" id="error-memberBirthPlace<?= $i ?>"><?= isset($arrayInfoMessages[$i]['memberBirthPlace' . $i]) && !empty($arrayInfoMessages[$i]['memberBirthPlace' . $i]) ? htmlspecialchars($arrayInfoMessages[$i]['memberBirthPlace' . $i]) : '' ?></p>
                                            </div>
                                        </div>
                                    </fieldset>
                                    ...
                                    <fieldset class="box rounded p-4 mt-5" form="">
                                        ...
                                        <div class="row justify-content-end">
                                            <div class="col-sm-10 col-md-4 col-xl-3 mt-3">
                                                ...
                                                <p class="text-danger m-0 error-message" id="error-memberStreetNumber<?= $i ?>"><?= isset($arrayInfoMessages[$i]['memberStreetNumber' . $i]) && !empty($arrayInfoMessages[$i]['memberStreetNumber' . $i]) ? htmlspecialchars($arrayInfoMessages[$i]['memberStreetNumber' . $i]) : '' ?></p>
                                            </div>
                                            <div class="col-sm-10 col-md-4 col-xl-9 mt-3">
                                                ...
                                                <p class="text-danger m-0 error-message" id="error-memberStreetName<?= $i ?>"><?= isset($arrayInfoMessages[$i]['memberStreetName' . $i]) && !empty($arrayInfoMessages[$i]['memberStreetName' . $i]) ? htmlspecialchars($arrayInfoMessages[$i]['memberStreetName' . $i]) : '' ?></p>
                                            </div>
                                            <div class="col-sm-10 col-md-4 col-xl-6 mt-3">
                                                ...
                                                <p class="text-danger m-0 error-message" id="error-memberStreetComplement<?= $i ?>"><?= isset($arrayInfoMessages[$i]['memberStreetComplement' . $i]) && !empty($arrayInfoMessages[$i]['memberStreetComplement' . $i]) ? htmlspecialchars($arrayInfoMessages[$i]['memberStreetComplement' . $i]) : '' ?></p>
                                            </div>
                                            <div class="col-sm-10 col-md-4 col-xl-3 mt-3">
                                                ...
                                                <p class="text-danger m-0 error-message" id="error-memberZipCode<?= $i ?>"><?= isset($arrayInfoMessages[$i]['memberZipCode' . $i]) && !empty($arrayInfoMessages[$i]['memberZipCode' . $i]) ? htmlspecialchars($arrayInfoMessages[$i]['memberZipCode' . $i]) : '' ?></p>
                                            </div>
                                            <div class="col-sm-10 col-md-4 col-xl-3 mt-3">
                                                ...
                                                <p class="text-danger m-0 error-message" id="error-memberCity<?= $i ?>"><?= isset($arrayInfoMessages[$i]['memberCity' . $i]) && !empty($arrayInfoMessages[$i]['memberCity' . $i]) ? htmlspecialchars($arrayInfoMessages[$i]['memberCity' . $i]) : '' ?></p>
                                            </div>
                                        </div>
                                    </fieldset>
                                    ...
                                    <fieldset class="box rounded p-4 mt-5 mb-2" form="">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-10 col-md-4 col-xl-6 mt-3">
                                                ...
                                                <p class="text-danger m-0 error-message" id="error-profession<?= $i ?>"><?= isset($arrayInfoMessages[$i]['profession' . $i]) && !empty($arrayInfoMessages[$i]['profession' . $i]) ? htmlspecialchars($arrayInfoMessages[$i]['profession' . $i]) : '' ?></p>
                                            </div>
                                            <div class="col-sm-10 col-md-4 col-xl-6 mt-3">
                                                ...
                                                <p class="text-danger m-0 error-message" id="error-familySituation<?= $i ?>"><?= isset($arrayInfoMessages[$i]['familySituation' . $i]) && !empty($arrayInfoMessages[$i]['familySituation' . $i]) ? htmlspecialchars($arrayInfoMessages[$i]['familySituation' . $i]) : '' ?></p>
                                            </div>
                                            <div class="col-sm-10 col-md-4 col-xl-6 mt-3">
                                                ...
                                                <p class="text-danger m-0 error-message" id="error-cafNumber<?= $i ?>"><?= isset($arrayInfoMessages[$i]['cafNumber' . $i]) && !empty($arrayInfoMessages[$i]['cafNumber' . $i]) ? htmlspecialchars($arrayInfoMessages[$i]['cafNumber' . $i]) : '' ?></p>
                                            </div>
                                        </div>
                                    </fieldset>
                                <?php
